...
import static com.example.vishal.mysy.R.drawable.back;
...
public class second extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent help= new Intent(second.this,HelpcenterChoice.class );
                startActivity(help);
            }
        });
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                {
                      firebase();
                   // web1.loadUrl("http://fineable-typists.000webhostapp.com/download.jpg");
                }
                else
                {
                    firebase1();
                   // web1.loadUrl("http://fineable-typists.000webhostapp.com/download1.jpg");
                }
                i++;
        ...
        web.setOnClickListener(new View.OnClickListener() {
            ...
            Intent o1=new Intent(second.this,web.class);
            startActivity(o1);
            }
        });
  ...
  public  void new1()
  {
      ...
      if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
          ...
          Intent i1=new Intent(second.this,new1.class);
          startActivity(i1);
    ...
    public  void renew()
    {
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED) {
            Intent i2=new Intent(second.this,renew.class);
            startActivity(i2);
    ...
    public  void form()
    {
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED) {
            Intent i3=new Intent(second.this,form.class);
            startActivity(i3);
    ...
    public  void reward()
    {
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED) {
            Intent i4=new Intent(second.this,reward.class);
            startActivity(i4);
        } else {
            Toast.makeText(getApplicationContext(), "NO INTERNET CONNECTION", Toast.LENGTH_LONG).show();
            connected = false;
    ...
    public  void user()
    {
        Intent save=new Intent(second.this,pass.class);
      startActivity(save);
    }
